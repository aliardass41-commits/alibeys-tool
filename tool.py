...
renk_listesi = [Fore.LIGHTRED_EX, Fore.LIGHTGREEN_EX, Fore.LIGHTYELLOW_EX, Fore.LIGHTBLUE_EX, Fore.LIGHTMAGENTA_EX, Fore.LIGHTCYAN_EX]

            
while 1:
    system("cls||clear")
    
    turbo_renk = random.choice(renk_listesi)
 ...
 ██   ██ ███████ ██ ██████  ███████    ██    ███████ 
    ...
    {}Servis Sayısı: {}           {}tiktok: {}@kali_ali44\n  
    """.format(Fore.LIGHTRED_EX, Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        print(Fore.LIGHTBLUE_EX + "  [ 1 ] -> SMS Gönder (Normal)\n")
        print(turbo_renk + "  [ 2 ] -> SMS Gönder (Turbo)\n")
        print(Fore.LIGHTBLUE_EX + "  [ 3 ] -> Çıkış\n")
